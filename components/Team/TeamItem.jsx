  ...
  return (
    <>
      <motion.div
        ...
        viewport={{ once: true }}
        className="animate_fade m-4 rounded-lg bg-white h-[75vh] p-4 pb-9 dark:bg-blacksection transition-all dark:hover:bg-hoverdark text-center"
      ...
      >
        <div className="h-[45vh] overflow-hidden rounded-lg">
          <img className="mx-auto w-[100%]" src={image} alt={name} />
          </div>
        <div className="px-4">
